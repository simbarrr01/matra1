...
function initWithdrawalPage() {
    ...
    // Load saved balances from sessionStorage
    loadSavedBalances();
...
function loadSavedBalances() {
    const savedBalances = sessionStorage.getItem('coinBalances');
    if (savedBalances) {
...
// Update coin balance and persist to sessionStorage
function updateCoinBalance(coin, amount) {
    ...
    sessionStorage.setItem('coinBalances', JSON.stringify(coinBalances));
}
...
function updateMainBalance() {
    ...
    sessionStorage.setItem('mainBalance', JSON.stringify(mainBalanceData));
...
function logout() {
    ...
    sessionStorage.removeItem('mainBalance');
